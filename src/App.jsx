...
const TYPES = {
  ...
  iI: { name:"心の橋渡し役",  sub:"共感者",   system:"🤝 協調タイプ", color:"#F59E0B", bg:"#FEF3C7",
    ...
    change: 35,
    growth:["相手に合わせすぎず、自分の意見も大切に","NOと言える勇気を持つ練習をしよう","時には自分のペースを優先することも必要"],
    compat:{ work:"サポート業務全般が得意。ルーティンワークも高品質", boss:"責任感の強い上司との相性が良い", peer:"優しく穏やかな同僚との相性が良い", ng_boss:"責任転嫁しやすい上司は苦手", ng_peer:"思考回路が読めない人は疲弊しやすい" } },
  iP: { name:"縁の下の太陽",  sub:"貢献者",   system:"🤝 協調タイプ", color:"#F59E0B", bg:"#FEF3C7",
    ...
    change: 50,
    growth:["周りを気にしすぎず、自分の判断を信じる","決断力を鍛えて主体的に行動する","自分の強みを積極的にアピールする習慣を"],
    compat:{ work:"サポート業務全般に向いている", boss:"責任感の強い上司との相性が良い", peer:"優しく穏やかな同僚との相性が良い", ng_boss:"責任転嫁しやすい上司は合わない", ng_peer:"思考回路が読めない部下は苦手" } },
  iA: { name:"頼れる守護者",  sub:"支援者",   system:"🤝 協調タイプ", color:"#F59E0B", bg:"#FEF3C7",
    ...
    change: 30,
    growth:["自分の意見を積極的に発信する練習を","タスクを抱え込みすぎず、周りに頼る","完璧主義を少し緩めてスピードも意識する"],
    compat:{ work:"事務・管理業務全般に高い適性", boss:"明確な指示を出してくれる上司が合う", peer:"安定感のある同僚と相性が良い", ng_boss:"気まぐれな指示を出す上司は苦手", ng_peer:"自己中心的な同僚とは疲弊しやすい" } },
  iD: { name:"深海の哲人",    sub:"思索者",   system:"🤝 協調タイプ", color:"#F59E0B", bg:"#FEF3C7",
    ...
    change: 40,
    growth:["思考を行動に移すスピードを上げる練習を","もっと自分の考えを外に発信してみよう","チームでのコミュニケーションを増やす"],
    compat:{ work:"分析・研究・企画職で高い成果を発揮", boss:"考える時間を与えてくれる上司が合う", peer:"知的な議論ができる同僚と相性が良い", ng_boss:"即断即決を求める上司は苦手", ng_peer:"感情的に動く同僚は疲弊しやすい" } },
  // P系統 バイタリティ
  pI: { name:"チームの火種",  sub:"協創者",   system:"⚡ 行動タイプ", color:"#EC4899", bg:"#FDF2F8",
    ...
    change: 45,
    growth:["専門スキルを一つ深掘りする習慣をつける","チームに頼りすぎず個人力も磨く","成果を数字で振り返る習慣を持とう"],
    compat:{ work:"チームでの対人業務・営業・調整役が得意", boss:"チームを大切にする上司との相性が良い", peer:"明るく協力的な同僚と相性が良い", ng_boss:"個人プレーを重視する上司は合わない", ng_peer:"孤立しがちな同僚とはすれ違いやすい" } },
  pP: { name:"場を彩る太陽",  sub:"活力者",   system:"⚡ 行動タイプ", color:"#EC4899", bg:"#FDF2F8",
    ...
    env:"活発でポジティブな雰囲気の職場",
    change: 55,
    growth:["計画を立てる習慣をつけて実行力を高める","感情に流されず論理的に考える練習を","一つのことをやり遂げる継続力を磨く"],
    compat:{ work:"営業・接客・イベント職で高い成果", boss:"自由にやらせてくれる上司が合う", peer:"ポジティブで行動的な同僚と相性が良い", ng_boss:"細かく管理してくる上司は窮屈に感じる", ng_peer:"後ろ向きな同僚はモチベが下がる" } },
  pA: { name:"こだわりの芸人", sub:"職人気質", system:"⚡ 行動タイプ", color:"#EC4899", bg:"#FDF2F8",
    ...
    change: 40,
    growth:["こだわりを持ちながらも締め切りを守る","専門性を活かしつつ他分野にも視野を広げる","自分の作品・成果を積極的にシェアする"],
    compat:{ work:"クリエイティブ・製造・専門職で高い成果", boss:"専門性を尊重してくれる上司が合う", peer:"同じ熱量でこだわれる同僚と相性が良い", ng_boss:"質より量を求める上司は合わない", ng_peer:"こだわりのない同僚とはすれ違いやすい" } },
  pD: { name:"道なき道を行く人", sub:"開拓者", system:"⚡ 行動タイプ", color:"#EC4899", bg:"#FDF2F8",
    ...
    change: 60,
    growth:["行動の前に少しだけ計画を立てる習慣を","失敗から学ぶPDCAサイクルを意識する","専門知識を一つ深掘りしてスキルを高める"],
    compat:{ work:"営業・起業・新規開拓職で高い成果", boss:"裁量を与えてくれる上司が合う", peer:"行動力のある同僚と相性が良い", ng_boss:"マイクロマネジメントする上司は苦手", ng_peer:"慎重すぎる同僚はテンポが合いにくい" } },
  // A系統 アナライズ
  aI: { name:"積み上げの達人", sub:"勤勉者",  system:"🧠 思考タイプ", color:"#0EA5E9", bg:"#EFF9FF",
    ...
    change: 30,
    growth:["自分の意見をもっと積極的に発言する","完成度より期限を意識してスピードUP","周りを頼ることでチームワークを高める"],
    compat:{ work:"正確さが求められる事務・管理・製造職", boss:"しっかり評価してくれる上司が合う", peer:"真面目で安定感のある同僚と相性が良い", ng_boss:"成果をきちんと評価しない上司は辛い", ng_peer:"いい加減な同僚とは仕事しにくい" } },
  aP: { name:"頼れる仕事人",  sub:"実務者",  system:"🧠 思考タイプ", color:"#0EA5E9", bg:"#EFF9FF",
    ...
    change: 35,
    growth:["成果を積極的にアピールする習慣をつける","コミュニケーションをもっと増やしてみる","新しい方法にも積極的にチャレンジする"],
    compat:{ work:"事務・施工管理・エンジニアなど幅広く活躍", boss:"仕事をきちんと評価してくれる上司が合う", peer:"信頼できる実力派の同僚と相性が良い", ng_boss:"感情的に振る舞う上司は苦手", ng_peer:"不誠実な同僚とは相性が悪い" } },
  aA: { name:"知の航海士",    sub:"探求者",  system:"🧠 思考タイプ", color:"#0EA5E9", bg:"#EFF9FF",
    ...
    change: 25,
    growth:["情報収集は適度に切り上げて行動に移す","専門知識を分かりやすく人に伝える練習を","積極的に人と交流してネットワークを広げる"],
    compat:{ work:"研究・分析・専門職で圧倒的な成果", boss:"専門知識を尊重してくれる上司が合う", peer:"知識欲のある同僚と相性が良い", ng_boss:"感覚で動く上司とは合いにくい", ng_peer:"浅く広くな同僚とはすれ違いやすい" } },
  aD: { name:"データの魔術師", sub:"分析者",  system:"🧠 思考タイプ", color:"#0EA5E9", bg:"#EFF9FF",
    ...
    env:"データや数字を扱う論理的な職場",
    change: 30,
    growth:["感情面にも配慮したコミュニケーションを意識","完璧を求めすぎず7割でGOを意識する","チームとの対話を増やして信頼関係を構築"],
    compat:{ work:"データ分析・エンジニア・コンサル職で高い成果", boss:"論理的に話せる上司との相性が良い", peer:"データや事実で話せる同僚と相性が良い", ng_boss:"感情論で動く上司は苦手", ng_peer:"非論理的な同僚とはフラストレーションが溜まりやすい" } },
  // D系統 イノベート
  dI: { name:"波を起こす人",  sub:"推進者",  system:"🚀 挑戦タイプ", color:"#10B981", bg:"#ECFDF5",
    ...
    change: 55,
    growth:["一人で深く考える時間も意識的に作る","衝動的な決断の前に一呼吸置く習慣を","長期的な関係を大切にする意識を持つ"],
    compat:{ work:"営業・販売・プロジェクト推進で高い成果", boss:"自由にやらせてくれる上司が合う", peer:"行動力のある同僚と相性が良い", ng_boss:"細かく制限をかける上司は苦手", ng_peer:"慎重すぎる同僚とはテンポが合わない" } },
  dP: { name:"旗手",          sub:"指揮者",  system:"🚀 挑戦タイプ", color:"#10B981", bg:"#ECFDF5",
    ...
    change: 50,
    growth:["チームメンバーの声をより丁寧に聞く","時に立ち止まってチームの状態を確認する","信頼できる参謀役を見つけてバランスを取る"],
    compat:{ work:"管理職・営業・施工管理で高い成果", boss:"裁量を与えてくれる上司が合う", peer:"実行力のある同僚と相性が良い", ng_boss:"細かく管理してくる上司は合わない", ng_peer:"受け身な同僚にはフラストレーションを感じやすい" } },
  dA: { name:"広角の先導者",  sub:"調和者",  system:"🚀 挑戦タイプ", color:"#10B981", bg:"#ECFDF5",
    ...
    change: 45,
    growth:["専門性を一つ決めて深掘りする時期を作る","一人の時間を確保してエネルギーを回復する","小さな成功体験を積み上げて自信を高める"],
    compat:{ work:"施工管理・コンサル・マネジメント職で活躍", boss:"成長を見守ってくれる上司が合う", peer:"専門性の高い同僚と相性が良い", ng_boss:"短期的な成果だけを求める上司は合わない", ng_peer:"視野の狭い同僚とはすれ違いやすい" } },
  dD: { name:"常識を壊す人",  sub:"革新者",  system:"🚀 挑戦タイプ", color:"#10B981", bg:"#ECFDF5",
    ...
    change: 55,
    growth:["周囲の意見も参考にしながら判断する柔軟性を","自分の専門以外にも視野を少し広げてみる","チームとのコミュニケーションを増やす"],
    compat:{ work:"エンジニア・専門職・起業家として高い成果", boss:"専門性を尊重して自由にやらせてくれる上司", peer:"同じ熱量で専門を追求できる同僚", ng_boss:"専門外のことを強制してくる上司は合わない", ng_peer:"こだわりのない同僚とはすれ違いやすい" } },
};
      ...
      <div style={{ maxWidth:700, margin:"0 auto", padding:"0 16px 80px" }}>
        ...
        <div style={{ background:C.bgCard, borderRadius:20, boxShadow:"0 3px 20px rgba(27,43,94,0.09)", padding:"24px", marginBottom:14 }}>
          <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:18 }}>
            ...
            <span style={{ fontSize:12, fontWeight:700, letterSpacing:"0.1em", color:C.txt3 }}>📊 スコア詳細分析</span>
          </div>
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:10 }}>
            {[
              { label:"協調性",     key:"I", color:"#F59E0B", icon:"🤝", desc:scores?.I>=67?"人との調和・サポート力が高い":scores?.I>=34?"バランスの取れた対人力":"独立心が強く自己完結型" },
              { label:"バイタリティ", key:"P", color:"#EC4899", icon:"⚡", desc:scores?.P>=67?"エネルギッシュで行動力抜群":scores?.P>=34?"状況に応じた適度な活力":"安定志向で持続力がある" },
              { label:"分析力",     key:"A", color:"#0EA5E9", icon:"🧠", desc:scores?.A>=67?"論理的思考と精度へのこだわり":scores?.A>=34?"バランスよく考えて行動できる":"直感と行動力で突破するタイプ" },
              { label:"行動力",     key:"D", color:"#10B981", icon:"🚀", desc:scores?.D>=67?"即断即決のスピード派":scores?.D>=34?"考えてから動くバランス派":"慎重に確実に進める安定派" },
              { label:"安定志向",   key:"X", color:"#8B5CF6", icon:"🛡️", desc:scores?.X>=67?"安定・継続を重視する堅実派":scores?.X>=34?"安定と挑戦のバランス派":"変化・挑戦を求めるアクティブ派" },
            ].map((ax,i)=>(
              <div key={ax.key} style={{ background:C.bgMist, borderRadius:12, padding:"14px 12px", borderLeft:`4px solid ${ax.color}` }}>
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:6 }}>
                  <span style={{ fontSize:12, fontWeight:700, color:C.txt2 }}>{ax.icon} {ax.label}</span>
                  <span style={{ fontSize:18, fontWeight:900, color:ax.color }}>{scores?.[ax.key]}%</span>
                </div>
                <div style={{ height:5, background:"#E2EBF6", borderRadius:99, marginBottom:6 }}>
                  <div style={{ height:"100%", width:`${scores?.[ax.key]||0}%`, background:ax.color, borderRadius:99, transition:"width 1s" }}/>
                </div>
                <p style={{ fontSize:11, color:C.txt3, lineHeight:1.5 }}>{ax.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ background:C.bgCard, borderRadius:20, boxShadow:"0 3px 20px rgba(27,43,94,0.09)", padding:"24px", marginBottom:14 }}>
          <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:18 }}>
            <div style={{ width:4, height:20, borderRadius:2, background:C.mint }}/>
            <span style={{ fontSize:12, fontWeight:700, letterSpacing:"0.1em", color:C.txt3 }}>💬 仕事・職場での相性</span>
          </div>
          <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
            {[
              { label:"得意な仕事",     icon:"💼", text:tp.compat?.work,     color:C.ocean,  bg:"#EFF9FF" },
              { label:"相性の良い上司", icon:"👆", text:tp.compat?.boss,     color:C.mint,   bg:"#EDFCF5" },
              { label:"相性の良い同僚", icon:"🤝", text:tp.compat?.peer,     color:C.violet, bg:"#F5F3FF" },
              { label:"苦手な上司",     icon:"⚠️", text:tp.compat?.ng_boss,  color:C.coral,  bg:"#FFF4EE" },
              { label:"苦手な同僚",     icon:"😓", text:tp.compat?.ng_peer,  color:"#F43F5E", bg:"#FFF1F2" },
            ].map((item,i)=>(
              <div key={i} style={{ display:"flex", gap:12, padding:"12px 14px", background:item.bg, borderRadius:12, alignItems:"flex-start" }}>
                <span style={{ fontSize:18, flexShrink:0 }}>{item.icon}</span>
                <div>
                  <div style={{ fontSize:11, fontWeight:700, color:item.color, marginBottom:3 }}>{item.label}</div>
                  <p style={{ fontSize:13, color:C.txt2, lineHeight:1.7 }}>{item.text}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ background:C.bgCard, borderRadius:20, boxShadow:"0 3px 20px rgba(27,43,94,0.09)", padding:"24px", marginBottom:14 }}>
          <div style={{ display:"flex", alignItems:"center", gap:8, marginBottom:18 }}>
            <div style={{ width:4, height:20, borderRadius:2, background:C.mint }}/>
            <span style={{ fontSize:12, fontWeight:700, letterSpacing:"0.1em", color:C.txt3 }}>🌱 あなたへの成長ヒント</span>
          </div>
          <div style={{ display:"flex", flexDirection:"column", gap:10 }}>
            {(tp.growth||[]).map((hint,i)=>(
              <div key={i} style={{ display:"flex", gap:12, padding:"14px 16px", background:i===0?"#ECFDF5":i===1?"#EFF9FF":"#F5F3FF", borderRadius:12, alignItems:"flex-start" }}>
                <div style={{ width:28, height:28, borderRadius:"50%", flexShrink:0, background:i===0?C.mint:i===1?C.ocean:C.violet, display:"flex", alignItems:"center", justifyContent:"center", color:"#fff", fontSize:13, fontWeight:900 }}>{i+1}</div>
                <p style={{ fontSize:13, color:C.txt2, lineHeight:1.75, paddingTop:3 }}>{hint}</p>
              </div>
            ))}
          </div>
        </div>
